#!/bin/bash
DIR="$HOME/.config/ThemeSwitcher/Themes/ColorThemes/Gruvbox-Light/Walls/BG"
...
ln -sf "$DIR/$selected" ~/.config/ThemeSwitcher/Themes/ColorThemes/Gruvbox-Light/Walls/1
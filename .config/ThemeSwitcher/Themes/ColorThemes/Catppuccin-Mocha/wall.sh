#!/bin/bash
DIR="$HOME/.config/ThemeSwitcher/Themes/ColorThemes/Catppuccin-Mocha/Walls/BG"
...
ln -sf "$DIR/$selected" ~/.config/ThemeSwitcher/Themes/ColorThemes/Catppuccin-Mocha/Walls/1
